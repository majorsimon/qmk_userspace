...
#define ADOPT_LUNA = yes
#define ADOPT_XOMT = yes
...
#define ENCODER_RESOLUTIONS \
    { 4 } // Left encoder seems to have double-output issue but right does not. This resolves that issue.
...
#    endif
//#define   _MODS_ENABLE			//Keep on master to save space (+138).
#endif
